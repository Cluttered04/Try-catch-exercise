    ...
    class Program
{
    ...
    */
        ...
        class AddressBook {
           public Dictionary<string, Contact> addresses {get; set;} = new Dictionary<string, Contact>();
           public void AddContact(Contact contactParam){
               try {
                   addresses.Add(contactParam.Email, contactParam);
    ...
    static void Main(string[] args)
    {
        ...
        foreach (string email in emails)
        {
            ...
            Console.WriteLine($"Address: {contact.Address}");
                ...
                Console.WriteLine("A contact matching that email does not exist!");
            }
